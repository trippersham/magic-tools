...
wrapper + the CI license audit are task 2.3.
    ...
    XMage jars: build the reactor (`mvn -pl Mage.Tests,Mage.Server.Plugins/Mage.Player.AI.MA,Mage.Server.Plugins/Mage.Game.CommanderDuel -am install -DskipTests`) at
