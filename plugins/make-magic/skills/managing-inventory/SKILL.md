...
7. Create/update the Deck record: Name, Format, Commander (link), Cards (link all non-commander non-basic-land cards), basic land counts (Plains/Islands/Swamps/Mountains/Forests/Wastes fields)
